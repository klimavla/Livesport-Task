...
fun SearchScreen() {
    ...
    val screenDataState by viewModel.screenDataState.collectAsState(listOf())
    ...
    Scaffold(
        ...
        Surface(
            ...
            SearchScreenContent(screenDataState)
        }
    }
}

@Composable
private fun SearchScreenContent(screenDataState: List<ResponsePlayer>) {
